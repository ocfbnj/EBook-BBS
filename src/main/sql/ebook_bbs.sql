...
-- 测试数据
call add_comment(null,
                 '“商场上的二八法则：一般而论，企业20%的核心客户会带来80%的利润； 同理，最核心的20%的时间会给你的职场带来80%的收获；20%的职场人脉也会给你带来80%的收益。 所以，空闲之余，多花点时间甄选20%的职场人脉，并且经营好这些职场人脉，你走向职场达人的道路就会更顺当一点。 无疑，华尔街的犹太圈子就是那20%的精华人脉。”',
                 1, 1);
